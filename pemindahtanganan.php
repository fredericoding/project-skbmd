...
$summary_query_sql = "SELECT 
                      ...
                      FROM pemindahtanganan $where_sql";
...
$total_records_sql = "SELECT COUNT(DISTINCT nama_skpd) as total FROM pemindahtanganan $where_sql";
...
<div class="container">
    <h1 class="page-title">Data Pemindahtanganan Barang</h1>
    ...
    <div class="card filter-export-card">
        <form action="pemindahtanganan.php" method="GET" class="filter-form-simple">
            ...
            <div class="filter-actions">
                ...
                <a href="pemindahtanganan.php" class="btn btn-secondary"><i class="fas fa-undo"></i> Reset</a>
            </div>
        </form>
...
<!-- Tambahan CSS untuk halaman ini (DIPERBARUI) -->
<style>
...
document.addEventListener('DOMContentLoaded', () => {
    $('.btn-details').on('click', function() {
        ...
        if (!button.hasClass('loaded')) {
            $.ajax({
                url: '<?= BASE_URL ?>/admin/ajax/get_pemindahtanganan_detail.php',
                type: 'POST',
                data: { skpd_name: skpd },
