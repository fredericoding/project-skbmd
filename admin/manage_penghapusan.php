...
// Logic is identical to manage_pemindahtanganan.php, just change the table name
$limit = 20;
...
// Count total
$total_sql = "SELECT COUNT(DISTINCT nama_skpd) as total FROM penghapusan $where_clause";
...
<div class="container-fluid">
    <h1 class="page-title-admin-content">Manajemen Data Penghapusan</h1>
                        ...
                        <?php if($result->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td class="action-cell">
                                    <a href="detail_skpd.php?type=penghapusan&skpd=<?= urlencode($row['nama_skpd']) ?>" class="btn-action btn-view">
                                        <i class="fas fa-eye"></i> Lihat Detail
                                    </a>
                                    <a href="delete_data.php?type=penghapusan&skpd=<?= urlencode($row['nama_skpd']) ?>" class="btn-action btn-delete" onclick="return confirm('ANDA YAKIN ingin menghapus SEMUA data dari SKPD ini? Aksi ini tidak dapat dibatalkan.')">
